...
//Went to manage vendor libraries and added the link:
//https://software-metadata.revrobotics.com/REVLib-2024.json (online)
//This is done for simulation which is done by simulating the robot
//with the command and then using advantage scope which is in start tool
//you then add the simulation which is in file and then use the 
